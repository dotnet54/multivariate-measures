package monashts.tempo.univariate.distances;

import static monashts.tempo.univariate.distances.utils.dist;
import static monashts.tempo.univariate.distances.utils.min;
...
public class WDTW {
	...
	static double distance(double[] lines, double[] cols, double[] weights, double cutoff) {
