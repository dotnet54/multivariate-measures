...
public class CDTW extends UnivariateMeasureWithPEA {

	protected int windowSize = -1;

	public CDTW(Measure measureName, boolean transformByFirstDerivative) {
		super(measureName);
	...
	public double distance_wrapper(double[] series1, double[] series2, double cutoff) {
		return distance(series1, series2, windowSize, cutoff);
	}

	private double distance(double[] lines, double[] cols, int w, double cutoff) {
	...
	public void setRandomParams(Dataset trainData, Random rand) {
		windowSize = rand.nextInt( trainData.length() / 4) + 1;
	}
