...
//	protected int maxLag;	//max lag for each interval is stored in the [][4] 4rd dim of intervals array
	...
	protected TSChiefOptions.RiseFeatures filter_type;
	...
	public RISETransformV1(TSChiefOptions.RiseFeatures filter_type, int num_intervals, int num_attribs, TSChiefOptions options) {
		this.options = options;

		minIntervalLength = options.rise_min_interval;
...
//		}
		...
		while(num_attribs < options.rif_splitters_per_node) {
...
//	        int interval_length = interval[1] - interval[0];
			...
			int[] interval = Util.getRandomIntervalSamplingLengthFirst(options.getRand(), options.rise_min_interval, fullLength, fullLength);
...
//	}
	...
	public String toString() {
		if (intervals != null) {
			return "RISE_TransformV1["+num_intervals+ ", filter_type: " + filter_type + "]";
		}
